      ...
      <Container>
        <div className="grid grid-cols-3">
          ...
          <div className="flex space-x-6 justify-center">
            {isMuted ? (
              <NoMic
                className="h-12 w-12 text-white p-2 cursor-pointer bg-red-500  rounded-md"
                onClick={() => toggleMuted()}
              />
            ) : (
              <Mic
                className="h-12 w-12 text-white p-2 cursor-pointer bg-gray-950  rounded-md"
                onClick={() => toggleMuted()}
              />
            )}
            {isCameraOff ? (
            ...
            <Phone
              onClick={logout}
              className="h-12 w-12 text-white hover:bg-red-500 p-2 cursor-pointer bg-primary rounded-md"
            />
          </div>
        </div>
      </Container>
